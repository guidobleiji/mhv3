...
if(is_singular('fotografie')){
	...
	echo '<meta property="og:image" content="'.$dienstAfb['url'].'">';
...
<div class="container-fluid fixed-top animatie" id="navigatie">
    <nav class="navbar navbar-expand-sm navbar-fixed-top d-flex justify-content-center p-0">
        <div class="navbar-collapse offcanvas-collapse d-flex align-items-center justify-content-center">
            <?php
            wp_nav_menu( array(
