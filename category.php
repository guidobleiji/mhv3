        ...
        <section class="container-fluid" id="intro">
            <div class="row">
                <div class="col-xs-12 offset-md-1 col-md-10 offset-lg-2 col-lg-8 offset-xl-3 col-xl-6 intro">
                    <h1>Blog</h1>
                    <p>Tips en adviezen of verhalen en ervaringen; af en toe schrijf ik een blogpost en die vind je hieronder.</p>
                </div>
            </div>
        </section>
        
        <section class="container-fluid mb-90 mt--120">
            <div class="row">
                            ...
                            echo '<aside class="blok animatie schaduw br d-md-flex bericht mb-30">';
                                ...
                                echo '<div class="col col-xl-8 p-30 align-self-center">';
                                    echo '<header class="d-flex align-items-center mb-30">';
                                        ...
                                        echo '<span class="m-0 ml-auto pull-right align-self-center">';
                                            echo '<i class="far fa-fw fa-calendar-alt" aria-hidden="true"></i> '.get_the_date().'';							
                                        echo '</span>';
                                    echo '</header>';
                                    echo '<p class="mb-30">'.get_field('blog_intro').'</p>';
                                    echo '<p><a href="'.get_permalink().'" class="meer-informatie animatie">Lees verder <i class="far fa-angle-right"></i></a></p>';
                                echo '</div>';
                            echo '</aside>';
                        }
                    }
